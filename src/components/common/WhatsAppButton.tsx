...
export function WhatsAppButton({ phoneNumber, companyName, message, className }: WhatsAppButtonProps) {
    ...
    return (
        <Link
            ...
            className={cn(
                "fixed bottom-24 right-4 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg transition-transform hover:scale-110 hover:shadow-xl animate-in fade-in zoom-in duration-300 md:bottom-6 md:right-6",
                className
            )}
