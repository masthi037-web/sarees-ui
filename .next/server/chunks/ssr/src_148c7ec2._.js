...
async function getRecommendationsAction(deliveryTime, categoryId, excludeProductId, companyId) {
    try {
        ...
        if (companyId) {
            const apiCategories = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$product$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchCategories"])(companyId, deliveryTime, true);
        ...
        if (allProducts.length === 0) {
            const fallbackCategories = companyId ? await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$product$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchCategories"])(companyId, deliveryTime, true) || [] : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$products$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["categories"];
...
function Recommendations({ categoryId, currentProductId }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchRecommendations = async ()=>{
            setLoading(true);
            const products = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getRecommendationsAction"])(companyDetails?.deliveryBetween, categoryId, currentProductId, companyDetails?.companyId);
        ...
        async function loadProduct() {
            ...
            if (foundProduct) {
                ...
                if (!foundCategoryId && companyDetails?.companyId) {
                    try {
                        const fetchedCategories = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$product$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchCategories"])(companyDetails.companyId, companyDetails.deliveryBetween);
                        const apiCat = fetchedCategories.find((c)=>c.catalogs.some((ca)=>ca.products.some((p)=>String(p.id) === String(foundProduct.id))));
                        if (apiCat) {
                                                        ...
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                                            ...
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                                                children: [
                                                                    {
                                                                        label: 'Color',
                                                                        value: selectedColourId ? product.colors?.find((c)=>c.id === selectedColourId)?.name || 'Mustard Yellow' : 'Mustard Yellow'
                                                                    },
                                                                    {
                                                                        label: 'Saree Fabric',
                                                                ...
                                                                ].map((spec, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
...
//# sourceMappingURL=src_148c7ec2._.js.map