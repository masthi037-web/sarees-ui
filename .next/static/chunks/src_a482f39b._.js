...
async function getRecommendationsAction(deliveryTime, categoryId, excludeProductId, companyId) {
    try {
        ...
        if (companyId) {
            const apiCategories = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$product$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchCategories"])(companyId, deliveryTime, true);
        ...
        if (allProducts.length === 0) {
            const fallbackCategories = companyId ? await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$product$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchCategories"])(companyId, deliveryTime, true) || [] : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$products$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["categories"];
...
function Recommendations(param) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Recommendations.useEffect": ()=>{
            const fetchRecommendations = {
                "Recommendations.useEffect.fetchRecommendations": async ()=>{
                    setLoading(true);
                    const products = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRecommendationsAction"])(companyDetails === null || companyDetails === void 0 ? void 0 : companyDetails.deliveryBetween, categoryId, currentProductId, companyDetails === null || companyDetails === void 0 ? void 0 : companyDetails.companyId);
        ...
        companyDetails === null || companyDetails === void 0 ? void 0 : companyDetails.companyId
    ]);
    if (loading) {
...
_s(Recommendations, "EEaYCaA9AbQgQy82Ta2bU0PSBBM=", false, function() {
    return [
...
function ProductDetailPage() {
    var _product_pricing, _product_pricing1, _product_colors_find, _product_colors;
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProductDetailPage.useEffect": ()=>{
            ...
            async function loadProduct() {
                ...
                if (!foundProduct && (companyDetails === null || companyDetails === void 0 ? void 0 : companyDetails.companyId)) {
                    try {
                        const fetchedCategories = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$product$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchCategories"])(companyDetails.companyId, companyDetails.deliveryBetween);
                ...
                if (foundProduct) {
                    ...
                    if (!foundCategoryId && (companyDetails === null || companyDetails === void 0 ? void 0 : companyDetails.companyId)) {
                        try {
                            const fetchedCategories = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$product$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchCategories"])(companyDetails.companyId, companyDetails.deliveryBetween);
                            const apiCat = fetchedCategories.find({
                                "ProductDetailPage.useEffect.loadProduct.apiCat": (c)=>c.catalogs.some({
                                        "ProductDetailPage.useEffect.loadProduct.apiCat": (ca)=>ca.products.some({
                                                "ProductDetailPage.useEffect.loadProduct.apiCat": (p)=>String(p.id) === String(foundProduct.id)
                                            }["ProductDetailPage.useEffect.loadProduct.apiCat"])
                                    }["ProductDetailPage.useEffect.loadProduct.apiCat"])
                            }["ProductDetailPage.useEffect.loadProduct.apiCat"]);
                            if (apiCat) {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "pt-4 border-t border-border/10 space-y-3",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                        className: "text-[10px] font-black text-muted-foreground uppercase tracking-[0.15em]",
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "border border-border/40 overflow-hidden bg-white text-xs",
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                                            ...
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                                                children: [
                                                                    {
                                                                        label: 'Color',
                                                                        value: selectedColourId ? ((_product_colors = product.colors) === null || _product_colors === void 0 ? void 0 : (_product_colors_find = _product_colors.find((c)=>c.id === selectedColourId)) === null || _product_colors_find === void 0 ? void 0 : _product_colors_find.name) || 'Mustard Yellow' : 'Mustard Yellow'
                                                                    },
                                                                    {
                                                                        label: 'Saree Fabric',
                                                                        value: product.name.includes('Organza') ? 'Pure Organza Silk' : product.name.includes('Banarasi') ? 'Pure Banarasi Silk' : 'Kanchipuram Silk'
                                                                    },
                                                                    {
                                                                        label: 'Zari Work Type',
                                                                        value: 'Fine Gold Zari Embroidered Borders'
                                                                    },
                                                                    {
                                                                        label: 'Blouse Type',
                                                                        value: 'Unstitched Blouse Material Included'
                                                                    },
                                                                    {
                                                                        label: 'Blouse Length',
                                                                        value: '80 Centimeters (0.8 Meters)'
                                                                    },
                                                                    {
                                                                        label: 'Saree Length',
                                                                        value: '5.5 Meters'
                                                                    ...
                                                                    {
                                                                        label: 'Occasion',
                                                                        value: 'Bridal, Wedding, Festive Wear'
                                                                    },
                                                                    {
                                                                        label: 'Care Instructions',
                                                                        value: 'Dry Clean Only'
                                                                    }
                                                                ].map((spec, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                                        className: "border-b border-border/20 last:border-b-0 hover:bg-[#f9f6f0]/50 transition-colors",
                                                                        children: [
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                                className: "py-2.5 px-4 font-bold text-muted-foreground uppercase tracking-wider text-[9px] w-1/3 bg-[#fdf9f2]/40 border-r border-border/20",
                                                                                children: spec.label
                                                                            }, void 0, false, {
                                                                                fileName: "[project]/src/app/product/[id]/page.tsx",
                                                                                lineNumber: 930,
                                                                            ...
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                                className: "py-2.5 px-4 text-[#1a1a1a] font-medium",
                                                                                children: spec.value
                                                                            }, void 0, false, {
                                                                                fileName: "[project]/src/app/product/[id]/page.tsx",
                                                                                lineNumber: 931,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            },
                            {
                                ...
                                className: "flex items-center gap-3 p-4 rounded-none border border-border/30 bg-card/50 backdrop-blur-sm hover:border-[#c2410c]/20 transition-all duration-300",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "w-10 h-10 rounded-none bg-[#c2410c]/5 flex items-center justify-center flex-shrink-0",
...
//# sourceMappingURL=src_a482f39b._.js.map