    ...
    const allNewArrivals = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HomeClient.useMemo[allNewArrivals]": ()=>{
            return activeCategory ? activeCategory.catalogs.flatMap({
                ...
                "HomeClient.useMemo[allNewArrivals]": (a, b)=>new Date(b.updatedAt).getTime() - new Date(a.updatedAt).getTime()
            }["HomeClient.useMemo[allNewArrivals]"]) : [];
        }
    }["HomeClient.useMemo[allNewArrivals]"], [
        activeCategory,
    ...
    const allFamousProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HomeClient.useMemo[allFamousProducts]": ()=>{
            return activeCategory ? activeCategory.catalogs.flatMap({
                ...
                "HomeClient.useMemo[allFamousProducts]": (a, b)=>new Date(b.updatedAt).getTime() - new Date(a.updatedAt).getTime()
            }["HomeClient.useMemo[allFamousProducts]"]) : [];
        }
    }["HomeClient.useMemo[allFamousProducts]"], [
        activeCategory,
...
//# sourceMappingURL=src_a580799b._.js.map